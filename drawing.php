...
if (!$result) {
	...
	<div class="container wrapper">
		...
		<h1 class="text-center">Drawing</h1>

		<div class="row">
			<div class="col-xs-4 col-xs-offset-8">
				<form action="drawingSearch.php" method="get" class="form-inline search-form" role="form">
					<div class="input-group">
						<label class="sr-only" for="drawingSearch">Drawing</label>
