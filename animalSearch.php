...
//select statement
$query_str = "SELECT * FROM $tblAnimal WHERE animal_name LIKE '%" .$name. "%' ";
...
if (!$result) {
	...
	<div class="container wrapper">
		...
		<ul class="breadcrumb">
			...
			<li><a href="animal.php">Wallpaper</a></li>
			...
			<div class="col-xs-4 col-xs-offset-8">
				<form action="<?=$_SERVER['PHP_SELF']?>" class="form-inline search-form" method="get" role="form">
					<div class="input-group">
						<label class="sr-only" for="animalSearch">Search animal</label>
