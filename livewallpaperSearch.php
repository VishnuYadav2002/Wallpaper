...
//select statement
$query_str = "SELECT * FROM $tblLivewp WHERE wp_name LIKE '%" .$name. "%' ";
			...
			<div class="col-xs-4 col-xs-offset-8">
				<form action="<?=$_SERVER['PHP_SELF']?>" class="form-inline search-form" method="get" role="form">
					<div class="input-group">
						<label class="sr-only" for="livewallpaperSearch">Search Image</label>
						<div class="input-group-addon"><i class="fa fa-search fa-lg"></i></div>
						<input type="text" name="livewp" placeholder="Search" id="livewallpaperSearch" class="form-control"/>
					</div>
					...
					<div class="thumbnail">
						<div class="caption">
							<div class="text-center">
									...
									<img src="<?php echo $result_row['wp_path'] ?>" style="height: 500px;" download> 
								</a>
							</div>
